 ...
 */
final class Version20190902114916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE telephone (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', refuser_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', numero VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_450FF0102B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE telephone ADD CONSTRAINT FK_450FF0102B445CEF FOREIGN KEY (refuser_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE telephone DROP FOREIGN KEY FK_450FF0102B445CEF');
